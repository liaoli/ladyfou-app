...
class PreferentialListWidget extends StatelessWidget {
  const PreferentialListWidget({Key? key, required this.cartTextList})
      : super(key: key);

  final List<String> cartTextList;
  ...
  Widget build(BuildContext context) {
    ...
    return SliverToBoxAdapter(
      child: Container(
        ...
        height: cartTextList.length * 38,
        decoration: new BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.all(Radius.circular(8.0)),
        ),
        child: ListView.builder(
          itemCount: cartTextList.length,
          shrinkWrap: true,
